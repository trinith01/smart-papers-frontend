          ...
          <CardContent className="p-4 sm:p-6">
            {!studyPlan && !studyPlanLoading && (
              <div className="text-center py-6 sm:py-8">
                <div className="relative mb-4 sm:mb-6">
                  ...
                  <div className="relative bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 sm:p-8">
                    <Brain className="h-12 w-12 sm:h-16 sm:w-16 mx-auto text-purple-600 mb-4" />
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">
                      Ready to Create Your Study Plan?
                    </h3>
                    <p className="text-gray-600 mb-4 sm:mb-6 max-w-md mx-auto text-sm sm:text-base">
                      Our AI will analyze your performance data and create a
                      personalized study plan to help you improve in areas where
                      you need the most focus.
                    </p>
                    <Button
                      onClick={getStudyPlan}
                      disabled={studyPlanLoading}
                      className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white shadow-lg px-6 sm:px-8 py-2 sm:py-3 w-full sm:w-auto"
                    >
                      {studyPlanLoading ? (
                        <>
            ...
            {studyPlanLoading && (
              <div className="text-center py-8 sm:py-12">
                <div className="relative">
                  ...
                  <div className="relative bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 sm:p-8">
                    <Loader2 className="h-10 w-10 sm:h-12 sm:w-12 animate-spin mx-auto text-purple-600 mb-4" />
                    <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">
                      Creating Your Study Plan
                    </h3>
                    <p className="text-gray-600 text-sm sm:text-base">
                      Our AI is analyzing your performance and generating
            ...
            {studyPlanError && (
              <div className="text-center py-6 sm:py-8">
                <div className="relative">
                  <div className="absolute inset-0 bg-red-100/50 rounded-full blur-xl"></div>
                  <div className="relative bg-red-50/80 backdrop-blur-sm border border-red-200/50 rounded-2xl p-6 sm:p-8">
                    ...
                    <Button
                      onClick={getStudyPlan}
                      variant="outline"
                      className="border-red-300 text-red-700 hover:bg-red-50 bg-transparent w-full sm:w-auto"
                    >
                      Try Again
                    </Button>
                  </div>
            ...
            {studyPlan && (
              <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-gray-600">
                        Generated based on your performance analysis
                      </p>
                    </div>
                  </div>
                  <Button
                    ...
                    size="sm"
                    disabled={studyPlanLoading}
                    className="bg-white/80 hover:bg-purple-50 hover:border-purple-300 w-full sm:w-auto"
                  >
                    {studyPlanLoading ? (
                      <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                    ) : (
                ...
                <div className="bg-gradient-to-br from-purple-50/50 to-indigo-50/50 rounded-xl p-4 sm:p-6 border border-purple-200/50">
                ...
                <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-500 bg-gray-50/50 rounded-lg p-3">
                  <Calendar className="h-4 w-4" />
                  <span>
                    Study plan generated on {new Date().toLocaleDateString()}
                  </span>
                </div>
              </div>
            )}
